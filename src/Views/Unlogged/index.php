  ...
  <body>
    ...
    <div class="partie2">
      ...
      <div class="colonne1">
        ...
        <a href="Notre_Produit.html"><button class="button1">En Savoir Plus</button></a>
      </div>
    </div>
    <div class="partie3">
      ...
      <div class="colonne2">
        ...
        <a href="APropos.html"><button class="button2">Nous Découvrir</button></a>
      </div>
    </div>
    <footer>
      <div class="footer">
        <div class="listFooter">
          <div class="BeCareful">
            ...
            <a class="link" href="../Unlogged/APropos.html"><p>Qui sommes-nous ?</p></a>
            <p>Adresse : 10 Rue de Vanves,92130, Issy-les-Moupneaux</p>
            <p>Horaires : Du lundi au samedi de 9h à 18h</p>
            <a class="link" href="../Unlogged/Notre_Produit.html"><p>Notre Produit</p></a>
          </div>
        </div>
        <div>
          <div class="BeCareful">
            <p class="title">Aide</p>
            <a class="link" href="../Unlogged/FAQ.html"><p>FAQ</p></a>
            <p>© BeCareful 2023</p>
          </div>
        </div>
        <div class="BeCareful">
